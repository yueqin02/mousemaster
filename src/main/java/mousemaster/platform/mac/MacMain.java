...
public class MacMain {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MacMain.class);
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        String version;
        String commitId;
        try (InputStream versionInputStream = MacMain.class.getClassLoader()
                                                           .getResourceAsStream(
        ...
        if (options.showVersion()) {
            System.out.println("mousemaster v" + version + " (" + commitId + ") for macOS");
            return;
        }
        ...
        logger.info("mousemaster v" + version + " (" + commitId + ") for macOS");
        if (platform == null)
            return;
        try {
    ...
    private static Platform createPlatform(boolean multipleInstancesAllowed,
        ...
        try {
            return new MacPlatform(multipleInstancesAllowed, keyRegurgitationEnabled,
